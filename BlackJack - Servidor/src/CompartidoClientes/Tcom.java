...
/*Geo, todo esto es lo que vas a tener que recibir.*/
...
public class Tcom implements Serializable{
    ...
    public void listarTcom() {
        ...
        System.out.println("Jugador nombre : "+this.nicks[0]);
        System.out.println("Jugador nombre : "+this.nicks[1]);
        System.out.println("Jugador nombre : "+this.nicks[2]);
        System.out.println("Jugador nombre : "+this.nicks[3]);

        System.out.println("idmesa: "+this.idm);
        System.out.println("turno...:"+this.turno);
        System.out.println("fase  : "+this.fase);
        System.out.println("num jugadores : "+this.numJugadores);
        System.out.println("el ultimo es : "+this.ultimo);
